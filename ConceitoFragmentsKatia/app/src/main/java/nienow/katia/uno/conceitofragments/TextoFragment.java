...
public class TextoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View toolBarLayoutInflated = inflater.inflate(R.layout.fragment_texto, container, false);

        tvExibirTexto = toolBarLayoutInflated.findViewById(R.id.tvExibirTexto);
